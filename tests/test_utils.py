...
from boltzjobs.utils import (
    ...
    single_quoted_representer,
    get_msa_from_json,
    get_templates_from_json,
    fasta_sequences,
)
...
class TestIndentedDumper:
    ...
    def test_indented_dumper_basic(self):
        ...
        data = {
            "version": 1,
            "sequences": [{"protein": {"id": "A", "sequence": "TEST"}}],
        }
...
class TestMSAFromJSON:
    ...
    def test_get_msa_from_json_rna(self, tmp_path):
        ...
        json_data = {
            "sequences": [{"rna": {"sequence": "AUCG", "unpairedMsa": "rna_msa_data"}}]
        }
...
class TestTemplatesFromJSON:
    ...
    def test_get_templates_from_json_found(self, tmp_path):
        ...
        json_data = {
            "sequences": [
                {"protein": {"sequence": "TESTSEQ", "templates": template_data}}
            ]
        }
